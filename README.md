# phpBB Loading indicator Extension
...
4. Copy the `loadingindicator` folder to `phpBB/ext/dmzx/` (if done correctly, you'll have the main extension class at (your forum root)/ext/dmzx/loadingindicator/composer.json).
